"""
Django settings for swiftdemoapp_48291 project.
...
ROOT_URLCONF = 'swiftdemoapp_48291.urls'
...
WSGI_APPLICATION = 'swiftdemoapp_48291.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "swiftdemoapp_48291 API",
    "DESCRIPTION": "API documentation for swiftdemoapp_48291 App",
    "VERSION": "v1",
}
